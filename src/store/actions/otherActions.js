  ...
  return async (dispatch) => {
    try {
      const res = await axiosClient().get(
        `platforms/c5864129-0644-aec7-b8cb-fd968072d3d8/products`
      );
...
export function getProfileProducts(id) {
  return async (dispatch) => {
    try {
      const res = await axiosClient().get(
        `platforms/c5864129-0644-aec7-b8cb-fd968072d3d8/products?vendorId=${id}`
      );
      NotificationManager.success("products Found");
...
export function getVendors() {
  return async (dispatch) => {
    try {
      const res = await axiosClient().get(
        `platforms/c5864129-0644-aec7-b8cb-fd968072d3d8/vendors`
      );
...
export function explore() {
  return async (dispatch) => {
    try {
      const res = await axiosClient().get(
        `platforms/c5864129-0644-aec7-b8cb-fd968072d3d8/products?maxRange=2&currency="ETH"`
      );

      dispatch(exploreAction(res.data.products));
    } catch (err) {
      console.log(err);
      NotificationManager.error(err.response?.data.message);
    }
...
export function hotCollection() {
  return async (dispatch) => {
    try {
      ...
      dispatch(hotCollectionAction(res.data.products));
    } catch (err) {
      console.log(err);
      NotificationManager.error(err.response?.data.message);
    }
...
function getUserToken(token) {
  ...
  return async (dispatch) => {
    try {
      const res = await axios.post(
        "https://dev-backend.shoptype.com/authenticate",
        {
          userType: "vendor",
        },
        options
